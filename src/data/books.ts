...
export const books: Book[] = [
  ...
  },
  {
    ...
    previewPages: [
      { pageNumber: 1, content: "ভূমিকা\n\nনতুন কাস্টমার আনতে যত খরচ হয়, পুরনো কাস্টমার ধরে রাখতে তার ৫ ভাগের ১ ভাগ খরচ হয়। তাহলে কেন আমরা সব বাজেট নতুন কাস্টমার আনতে ব্যয় করি?\n\nএই বইয়ে শিখুন কীভাবে কাস্টমার সার্ভিসকে আপনার সবচেয়ে শক্তিশালী মার্কেটিং টুল বানাবেন।" },
      { pageNumber: 2, content: "অধ্যায় ১: কাস্টমার সাইকোলজি\n\n১.১ কাস্টমার এক্সপেকটেশন\n\nবাংলাদেশের অনলাইন কাস্টমারদের ৩টি প্রধান চাহিদা:\n\n১। দ্রুত রেসপন্স (৫ মিনিটের মধ্যে)\n২। সৎ তথ্য (প্রোডাক্ট যেমন দেখায় তেমনই পান)\n৩। সহজ রিটার্ন প্রক্রিয়া\n\nএই তিনটি বিষয় ঠিক করতে পারলে আপনার ৮০% কাস্টমার সমস্যা সমাধান হয়ে যাবে।" },
    ],
    faq: [
